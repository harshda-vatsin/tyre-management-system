/**
 * Helper utilities for EBTMS tyre QR payload formatting and validation.
 */
 ...
 */
function generateQrPayload(tyreNumber) {
...
module.exports = { generateQrPayload, parseQrPayload };
