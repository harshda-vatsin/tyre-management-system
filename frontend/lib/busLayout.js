...
const LAYOUTS = {
  ...
  6: [
    { code: 'FL', row: 0, side: 'L', slot: 'single' },
    { code: 'FR', row: 0, side: 'R', slot: 'single' },
    { code: 'RLO', row: 1, side: 'L', slot: 'outer' },
    { code: 'RLI', row: 1, side: 'L', slot: 'inner' },
    { code: 'RRI', row: 1, side: 'R', slot: 'inner' },
    { code: 'RRO', row: 1, side: 'R', slot: 'outer' },
  ],
  10: [
    { code: 'FL', row: 0, side: 'L', slot: 'single' },
    { code: 'FR', row: 0, side: 'R', slot: 'single' },
    ...
    { code: 'RRI', row: 1, side: 'R', slot: 'inner' },
    { code: 'RRO', row: 1, side: 'R', slot: 'outer' },
    { code: 'R2LO', row: 2, side: 'L', slot: 'outer' },
    { code: 'R2LI', row: 2, side: 'L', slot: 'inner' },
    { code: 'R2RI', row: 2, side: 'R', slot: 'inner' },
    { code: 'R2RO', row: 2, side: 'R', slot: 'outer' },
  ],
};
